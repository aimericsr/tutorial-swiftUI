...
struct FoodItemAsync: Identifiable {
...
extension FoodItemAsync {
    
    static var preview: FoodItemAsync {
        FoodItemAsync(imgUrl: "https://infatuation.imgix.net/media/images/guides/6-diy-burger-meal-kits/banners/1606222689.1394382.png",
