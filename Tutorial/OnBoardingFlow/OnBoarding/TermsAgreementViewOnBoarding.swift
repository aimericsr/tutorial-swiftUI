...
struct TermsAgreementViewOnBoarding: View {
    let action: () -> Void
    var body: some View {
...
struct TermsAgreementViewOnBoarding_Previews: PreviewProvider {
    static var previews: some View {
        TermsAgreementViewOnBoarding {}
    }
}

private extension TermsAgreementViewOnBoarding {
